...
if __name__ == '__main__':
    ...
    tokenizer = BertTokenizer.from_pretrained(args.pretrain_model_dir, do_lower_case=args.do_lower_case)
    _, val_dataloader = create_dataloaders(args, tokenizer)
    model = BertForSequenceClassification(args.pretrain_model_dir)
    model.to(device)
