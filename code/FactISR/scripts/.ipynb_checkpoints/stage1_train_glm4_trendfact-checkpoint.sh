...
OUTPUT_DIR=../../output/glm4_stage1_train_ep4_trending/fold0
mkdir -p $OUTPUT_DIR
...
OUTPUT_DIR=../../output/glm4_stage1_train_ep4_trending/fold1
mkdir -p $OUTPUT_DIR
...
OUTPUT_DIR=../../output/glm4_stage1_train_ep4_trending/fold2
mkdir -p $OUTPUT_DIR
...
OUTPUT_DIR=../../output/glm4_stage1_train_ep4_trending/fold3
mkdir -p $OUTPUT_DIR
...
OUTPUT_DIR=../../output/glm4_stage1_train_ep4_trending/fold4
mkdir -p $OUTPUT_DIR
