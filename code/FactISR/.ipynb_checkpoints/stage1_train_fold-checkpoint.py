...
from data_helpers.data_helper_v3 import CEGDataSet, DataCollatorForCEG
...
def main():
    ...
    for train_index, val_index in kf.split(train_data):
        ...
        del model, trainer, train_dataset, data_collator, train_fold
